...
class ChatModel:
    def __init__(self, model_id: str, model_kwargs: Dict):
        self.model_id = model_id
        self.model_kwargs = model_kwargs
        self.llm = BedrockChat(model_id=model_id, model_kwargs=model_kwargs, streaming=True)
    ...
    def format_prompt(self, prompt: str) -> Union[str, List[Dict]]:
        ...
        """
        model_config = config["models"][self.model_id]
